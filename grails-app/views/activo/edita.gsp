...
<html>
	...
	<body>
		<a href="#edit-activo" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-activo" class="content scaffold-edit" role="main">
			...
			<ul class="errors" role="alert">
				<g:eachError bean="${activo}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${activo?.version}" />
				<fieldset class="form">
